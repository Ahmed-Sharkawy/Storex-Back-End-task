            ...
            <div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative"
                ...
                <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
                    ...
                    <div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-350px"
                        style="background-image: url(assets/media/illustrations/unitedpalms-1/13.png"></div>
                    <!--end::Illustration-->
                </div>
                <!--end::Wrapper-->
            </div>
            ...
            <div class="d-flex flex-column flex-lg-row-fluid py-10">
                ...
                <div class="d-flex flex-center flex-column flex-column-fluid">
                    ...
                    <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                        ...
                        @endif
                        <form action="{{ route('auth.login') }}" method="POST" class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="#">
                            <!--begin::Heading-->
                            @csrf
                            ...
                            <div class="text-center">
                                <!--begin::Submit button-->
                                <button class="btn btn-lg btn-primary w-100 mb-5" type="submit">Login</button>
                                <!--end::Submit button-->
                                <!--begin::Separator-->
