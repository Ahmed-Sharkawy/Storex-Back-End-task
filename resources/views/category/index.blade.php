                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <!--begin::Add user-->
                                <a href="{{ route('categorys.create') }}" style="border-radius: 5px" class="btn btn-primary">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                    ...
                                    <tbody class="text-gray-600 fw-bold">
                                        @foreach ($categorys as $category)
                                            <tr class="odd">
                                                <td valign="top" class="dataTables_empty">{{ $category->title }}</td>
                                                ...
                                                <td valign="top" class="dataTables_empty">
                                                    <a href="{{ route('categorys.destroy', $category->id) }}"
