...
@section('main')
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_account_profile_details" class="collapse show">
            <!--begin::Form-->
            <form action="{{ route('movies.store') }}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form"
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="rounded border p-10">
                            ...
                            <textarea name="description" class="form-control" data-kt-autosize="true">{{ old('rate') }}</textarea>
                        </div>
                        @error('description')
                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                        @enderror
